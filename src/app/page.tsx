    ...
    <div className="min-h-screen max-w-screen overflow-hidden flex flex-col">
      <main className="h-screen w-screen flex items-center justify-center flex-col relative">
        ...
        <div className="relative w-fit">
          ...
          <a className="w-full mt-1 rounded-4xl bg-black opacity-50 p-2 text-white h-fit duration-200 hover:opacity-90 select-none cursor-grab" href="https://github.com/FilippoDude">Github</a>
        </div>
      ...
      <section className="w-screen  flex justify-center items-center h-screen bg-black z-10">
        <div>
          ...
          <p className="text-xl text-white mt-2">I&apos;ve worked on many different projects ranging from static and React Websites to Telegram Bots and Miniapps.<br/>
