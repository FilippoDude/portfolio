    ...
    return(
        <section ref={ref} className="relative min-h-180 h-fit py-20 xl:py-0 xl:h-screen w-screen overflow-hidden flex justify-center items-center  bg-[#131522] z-10">
            ...
            <div className="relative z-1 w-10/12 h-fit py-20 xl:py-0 xl:h-10/12 bg-[#1c2032d8] rounded-2xl flex flex-wrap items-center justify-center gap-10 border-2 border-gray-500 ">
                ...
                <div className={`relative xl:-mt-20 w-68 h-80 bg-[#E89947] flex flex-col items-center px-12 flex-shrink-0 duration-500 transition-all ease-in-out ${isVisible ? 'xl:-mt-20 opacity-100' : 'xl:mt-0 opacity-0'}`}>
                <div>
                ...
                <div className={`xl:mt-20 w-68 h-80 bg-[#2E3754] flex flex-col items-center px-12 flex-shrink-0 duration-1000 transition-all ease-in-out ${isVisible ? 'xl:mt-20 opacity-100' : 'xl:mt-25 opacity-0'}`}>
                    <div>
