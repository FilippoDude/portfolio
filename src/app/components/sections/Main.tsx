...
const MainSection = ({
  ...
  skillsSectionRef: React.Ref<HTMLElement | null>;
  aboutmeRef: React.Ref<HTMLElement | null>;
}) => {
  ...
  const scrollToSkills = () => {
    if (
      skillsSectionRef &&
      typeof skillsSectionRef !== "function" &&
  ...
  return (
    <main
      ref={ref}
      className={`min-h-180 h-screen w-screen flex items-center justify-center flex-row relative gap-10`}
    >
      <div
        className={`h-fit z-10 px-10 xl:pl-0 transition-all duration-1000 ease-in-out transform ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"}`}
      >
        <div className="relative">
          <h1
            ref={titleRef}
            className="select-none absolute text-center sm:text-left text-7xl sm:text-8xl font-raleway-sans font-bold text-white blur-xs opacity-0"
          >
            Filippo Grochala
          </h1>
          <h1
            ref={titleBlurRef}
            className="text-center sm:text-left text-7xl sm:text-8xl font-raleway-sans font-bold text-[#FFFFFF20]"
          >
            Filippo Grochala
          </h1>
        </div>
        <div className="mt-2 relative w-full flex flex-col items-center sm:items-start">
          <div ref={subtitleRef} className="relative opacity-50 ">
            <p className="absolute text-3xl w-80 sm:w-fit text-center sm:text-left sm:text-3xl opacity-70 font-sans text-white blur-xs select-none">
              Web and Mobile Developer since 2020
            </p>
            <p className="text-3xl w-80 sm:w-fit text-center sm:text-left sm:text-3xl opacity-70 font-sans text-white">
              Web and Mobile Developer since 2020
            </p>
          </div>
          <div>
            <p className="text-xl w-72 sm:w-fit text-center sm:text-left sm:text-xl mt-2 opacity-60 font-sans text-white">
            ...
            <p className="text-xl w-72 sm:w-fit text-center sm:text-left sm:text-xl font-sans text-white">
              <button
                ...
                className="group cursor-pointer text-[#E49D53]"
              >
                me
                <div className="group-hover:w-full h-0.5 w-0 bg-[#E49D53] duration-100"></div>
              </button>
              ...
              <button
                ...
                className="group cursor-pointer text-[#425173]"
              >
                projects
                <div className="group-hover:w-full h-0.5 w-0 bg-[#425173] duration-100"></div>
              </button>
            </p>
          </div>
        </div>
        <div className="flex items-center flex-col sm:items-start">
          <div className="mt-4 min-w-fit relative flex flex-col md:flex-row items-center sm:items-start md:items-center gap-2">
            <div className="flex flex-col sm:flex-row gap-4 items-center bg-[#17192A] px-4 py-4 sm:py-4 peer-16 rounded-2xl justify-center h-fit sm:h-16 min-w-fit flex-shrink-0">
              <img
                className="h-10"
                src="https://skillicons.dev/icons?i=angular,react,nodejs,typescript"
              ></img>
              <div className="hidden sm:flex min-w-0.5 h-10 bg-white opacity-70" />
              <img
                className="h-10"
                src="https://skillicons.dev/icons?i=androidstudio,flutter,kotlin"
              ></img>
              <div className="hidden sm:flex min-w-0.5 h-10 bg-white opacity-70" />
              <img
                className="h-10"
                src="https://skillicons.dev/icons?i=git,docker"
              ></img>
            </div>
            <Image
