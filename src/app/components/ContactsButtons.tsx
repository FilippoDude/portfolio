...
const ContactsButtons = () => {
    return (
        <div className="w-full mt-4 flex flex-row gap-2">
            <button onClick={() => window.location.href = 'https://t.me/FIlippodude'} className="relative w-16 h-16 cursor-pointer">
            <Image fill={true} className="" alt="telegram" src={"telegram.svg"}></Image>
            </button>
